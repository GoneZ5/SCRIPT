...
#        self.depth_embedding = nn.Embedding(90, dim)
...
#    def forward(self, source, memory_bank, depth, memory_lengths=None,
...
#        align = self.score(source, memory_bank, depth)
