...
def add_test_args(parser):
    ...
    files.add_argument('--model_dir', type=str, default='../model_java_best/',
                       help='Directory for saved models/checkpoints/logs')
    files.add_argument('--model_name', type=str, default='',
                       help='Unique model identifier (.mdl, .txt, .checkpoint)')
    files.add_argument('--data_dir', type=str, default='/data/gongzi/sit3/data/',
                       help='Directory of training/validation data')
    files.add_argument('--dev_src', nargs='+', type=str, default=['case.token.code'],
                       help='Preprocessed dev source file')
    files.add_argument('--dev_src_tag', nargs='+', type=str,
                       help='Preprocessed dev source tag file')
    files.add_argument('--dev_tgt', nargs='+', type=str, default=['case.token.nl'],
                       help='Preprocessed dev target file')
    files.add_argument('--dev_guid', nargs='+', type=str, default=['case.token.guid'],
...
#            depth_rep = depth_rep.cuda(non_blocking=True)
